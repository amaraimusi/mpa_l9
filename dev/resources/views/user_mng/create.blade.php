...
<head>
	...
	<script src="{{ asset('/js/UserMng/create.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/UserMng/create.css')  . $ver_str}}" rel="stylesheet">
	
	<title>ユーザー管理・新規登録フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">ユーザー管理・新規登録フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form method="POST" action="{{ url('user_mng/store') }}" onsubmit="return checkDoublePress()">
			@csrf
			
			<div class="row">
				<label for="name" class="col-12 col-md-5 col-form-label">ユーザー名</label>
				<div class="col-12 col-md-7">
					<input name="name" type="text"  class="form-control form-control-lg" placeholder="ユーザー名" value="{{old('name')}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="email" type="text"  class="form-control form-control-lg" placeholder="メールアドレス" value="{{old('email')}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="nickname" type="text"  class="form-control form-control-lg" placeholder="名前" value="{{old('nickname')}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="password" type="text"  class="form-control form-control-lg" placeholder="パスワード" value="{{old('password')}}">
				</div>
			</div>
