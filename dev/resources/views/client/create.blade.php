...
<head>
	...
	<script src="{{ asset('/js/Client/create.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/Client/create.css')  . $ver_str}}" rel="stylesheet">
	
	<title>顧客管理・新規登録フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">顧客管理・新規登録フォーム</li>
  </ol>
</nav>
		...
		<form method="POST" action="{{ url('client/store') }}" onsubmit="return checkDoublePress()">
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="client_name" type="text"  class="form-control form-control-lg" placeholder="顧客名" value="{{old('client_name')}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="tell" type="text"  class="form-control form-control-lg" placeholder="電話番号" value="{{old('tell')}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="address" type="text"  class="form-control form-control-lg" placeholder="住所" value="{{old('address')}}">
				</div>
			</div>
