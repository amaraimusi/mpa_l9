...
<head>
	...
	<script src="{{ asset('/js/NekoType/create.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/NekoType/create.css')  . $ver_str}}" rel="stylesheet">
	
	<title>ネコ種別管理・新規登録フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">ネコ種別管理・新規登録フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form method="POST" action="{{ url('neko_type/store') }}" onsubmit="return checkDoublePress()">
			@csrf
			<!-- CBBXS-3006 -->
			<div class="row">
				<label for="neko_type_name" class="col-12 col-md-5 col-form-label">neko_type_name</label>
				<div class="col-12 col-md-7">
					<input name="neko_type_name" type="text"  class="form-control form-control-lg" placeholder="neko_type_name" value="{{old('neko_type_name')}}">
				</div>
			</div>
			<div class="row">
